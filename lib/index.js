    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            if (enableModule) { // 启用了 css module
                ...
                return [2 /*return*/, {
                        map: (_a = postResult.map) === null || _a === void 0 ? void 0 : _a.toString(),
                        code: "require(import.meta.ROLLUP_FILE_URL_" + referenceId + ");\nexport default " + JSON.stringify(postResult.tokens)
                    }];
            }
            return [2 /*return*/, {
                    map: (_b = postResult.map) === null || _b === void 0 ? void 0 : _b.toString(),
...
function handlePostCss(options) {
    return __awaiter(this, void 0, void 0, function () {
        var fileName, source, cssModule, result, moduleOptions, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, postcss_1.default([postcss_modules_1.default(moduleOptions)]).process(source, { from: fileName })];
                case 1:
                    data = _a.sent();
                    result.css = data.css;
                    result.map = data.map;
